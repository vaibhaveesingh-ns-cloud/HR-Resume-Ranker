...
>>>>>>> feature/apoorva-initial-upload
                      ...
                      return (
                        <tr key={r.resume_id} className="border-t">
                            ...
                            {r.has_github ? (
                              <div className="flex items-center gap-2">
                                <div className="w-16 bg-slate-200 h-2 rounded">
                                  <div className="bg-purple-600 h-2 rounded" style={{ width: `${r.github_score}%` }}></div>
                                </div>
                                <span className="text-xs font-mono">{r.github_score}/100</span>
                              </div>
                            ) : (
...
>>>>>>> feature/apoorva-initial-upload
              ...
              {analysis.results.map((r) => {
                if (expandedResumeId !== r.resume_id) return null;
                const total = r.yes_count + r.no_count;
                return (
                  <div key={r.resume_id} className="mt-6 p-6 bg-white rounded-xl border shadow">
...
>>>>>>> feature/apoorva-initial-upload
                    ...
                    <div className="mt-4">
                      <h4 className="font-semibold text-slate-700 mb-2">Criteria breakdown</h4>
